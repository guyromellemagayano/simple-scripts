...
class RunnerTests(unittest.TestCase):
    ...
    def test_missing_runtime_has_actionable_error(self):
        with (
            mock.patch("practice.shutil.which", return_value=None),
            self.assertRaisesRegex(RuntimeError, "Required runtime 'node'.*PATH"),
        ):
    ...
    def test_timeout_stops_the_assessment_process_group(self):
        ...
        with (
            mock.patch("practice.subprocess.Popen", return_value=process),
